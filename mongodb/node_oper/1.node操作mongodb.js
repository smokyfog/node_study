...
//连接数据库    并实现查询功能
MongoClient.connect("mongodb://127.0.0.1:27017/dbyq",function(err, db){
    //err： 连接错误返回的对象  返回null 表示连接成功
    //db： 代表连接的数据库
    // console.log(err);
    //选择要操作的集合
    var yq = db.collection('yq');
    //查询功能
    // console.log(yq.find()) 
    
    //查询数据
    // yq.find().toArray(function(err, res){
    //     console.log(res)
    // })
    ...
    //插入数据
    // yq.insert({"name":"张三","age":2,"sex":'女'},function(err, res){
    //     console.log(res)
    // })
